      ...
      <li className={classNames}>
        <div className="view">
          <form onSubmit={this.onSubmit}>
            <input type="text" className={classEdit} defaultValue={label} onChange={this.onLabelChange} />
          </form>
          <input className="toggle" type="checkbox" defaultChecked={isChecked} onClick={onToggleCompleted} />
          <label>
